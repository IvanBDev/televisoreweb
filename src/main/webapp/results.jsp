...
<html>
	...
	<body>
			...
			<% List<Televisore> listaDaServlet = (List<Televisore>)request.getAttribute("listTelevisoriAttributeName");
				...
				<tr>
					...
					<td>
						...
						<a href = "PrepareUpdateServlet?idDaInviareComeParametro=<%=televisoreItem.getIdTelevisore() %>">Modifica</a>
		...
		<a href="PrepareInsertTelevisoreServlet">Inserisci un nuovo televisore</a>
	</body>
</html>