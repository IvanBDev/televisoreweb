...
<html>
	...
	<body>
			...
			<% List<Televisore> listaDaServlet = (List<Televisore>)request.getAttribute("listTelevisoriAttributeName");
				...
				<tr>
					...
					<td>
						...
						<a href = "PrepareModificaServlet?idDaInviareComeParametro=<%=televisoreItem.getIdTelevisore() %>">Modifica</a>
		...
		<a href="PrepareInsertAbitanteServlet">Inserisci un nuovo televisore</a>
	</body>
</html>